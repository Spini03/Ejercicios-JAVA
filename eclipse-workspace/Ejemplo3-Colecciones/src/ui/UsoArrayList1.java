...
public class UsoArrayList1 {
	...
	public static void main(String[] args) {
		...
		// System.out.println(mamals.get(4));  <--ERROR
		...
		// Remover por objeto utiliza el método equals de la clase
